...
{
    #region Dependencies & Student Metadata
    ...
    #region Hardware TImer & UI Clock
    ...
    #region Anti-Cheat Engine
        ...
        public System.Collections.Generic.List<string> IncidentLog { get; } = new();    [ObservableProperty] private bool _isFocusWarningVisible = false;
    ...
    #region Exam Navigation & Pagination
